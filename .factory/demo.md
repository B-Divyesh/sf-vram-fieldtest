...
- The real `vram-fieldtest inspect` command detects adapters and VRAM values on the host where a user runs it. It tests that host only. Coverage evidence comes from that host's completed user run.
