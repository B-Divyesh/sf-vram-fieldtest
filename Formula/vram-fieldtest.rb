class VramFieldtest < Formula
  ...
  version "0.1.4"
  if Hardware::CPU.arm?
    url "https://github.com/B-Divyesh/sf-vram-fieldtest/releases/download/v0.1.4/vram-fieldtest-macos-aarch64.tar.gz"
    sha256 "6b31086f12e57712e287fd4ffc314e3c968c317f0d43008fc9b2ec1bd0831cb1"
  else
    url "https://github.com/B-Divyesh/sf-vram-fieldtest/releases/download/v0.1.4/vram-fieldtest-macos-x86_64.tar.gz"
